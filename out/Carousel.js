...
import { View, Animated, ScrollView, StyleSheet, Platform, Dimensions, PanResponder } from 'react-native';
export default class Carousel extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(View, null,
            React.createElement(ScrollView, { ref: ref => this.scrollView = ref, style: { width: pageSize }, contentContainerStyle: { width: pageSize + 1 }, horizontal: true, pagingEnabled: true, directionalLockEnabled: true, bounces: false, alwaysBounceHorizontal: false, alwaysBounceVertical: false, showsVerticalScrollIndicator: false, showsHorizontalScrollIndicator: false, scrollEnabled: Platform.OS === 'ios' }, content),
